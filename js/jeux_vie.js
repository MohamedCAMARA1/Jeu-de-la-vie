...
// // pinceau.stroke();             //Traçage de la forme!
 ...
 //=============================   VAR     =====================================
 //=============================================================================
 let largeur = document.getElementById("Ma_largeur")
 let hauteur = document.getElementById("Ma_Hauteur") 
 let ecart =10; //largeur d'un côté des cases
  ...
  let btn_Ok = document.getElementById("ok")
...
function Aujourdhui(){
  for(let ligne = 0; ligne < Le_Canvas.width; ligne += ecart){    
     tab_Etat_Present[ligne]= new Array(Le_Canvas.height);
     tab_Futur[ligne]= new Array(Le_Canvas.height);    
     for(let colonne=0; colonne < Le_Canvas.height; colonne += ecart ){
...
else
{
      ...
      //          }        
        ...
        else{//sinon elle mourra On_est_Demain  
...
//fonction permettant de mettre l'etat (n+1) dans l'etat n
function On_est_Demain(){
...
let myVar
//fonction permettant de voir l'etat n+1 chaque 0.05 sec
function tempo() {
  myVar = setInterval(Demain, 5);
...
//   Le_Canvas.width = parseInt(hauteur.value,10)
//   Le_Canvas.height = parseInt(largeur.value,10)
//  })
